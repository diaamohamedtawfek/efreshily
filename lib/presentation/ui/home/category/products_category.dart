...
class _ProductsCategoryState extends State<ProductsCategory> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: const AppBarAll(nameAppBar: "Sofa", showBack: true),
        body: SafeArea(
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: TabBar(
                  ...
                  labelColor: const Color(0xfff7941d),
                  ...
                  tabs: [
                    ...
                    //   text:S.of(context).active_order,
                    // ),
              ...
              Padding(
                ...
                children: [
                  TextApp(
                    text: _tabController.index==1?S.of(context).allStores:S.of(context).allProducts ,
                  ...
                  TextApp(
                    text: "3589 ${_tabController.index==1?S.of(context).stores:S.of(context).products}",
              ...
              Expanded(
                child: TabBarView(
                  children: const [
                    ...
                    ListAllOffers(topSpace: 0,scrollPhysics: ScrollPhysics()),
...
//       padding: EdgeInsets.only(left: 15,right: 15,top: 0,bottom: MediaQuery.of(context).padding.bottom+20),
