...
import 'package:efreshily/presentation/ui/item/item.dart';
...
class AllNewAdded extends StatefulWidget {
  const AllNewAdded({Key? key}) : super(key: key);

  @override
  State<AllNewAdded> createState() => _AllNewAddedState();
}

class _AllNewAddedState extends State<AllNewAdded> {
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    width:  190,
                                    fit: BoxFit.fill,
                                    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQC-bSpugh1KyLXSssiDdcP97JzPz_i91nVGQ&usqp=CAU",
                                    placeholder: (context,
                                        url) =>
                                    const Center(child:
