...
class MotionTabBar extends StatefulWidget {
  ...
  MotionTabBar({Key? key,
    ...
    this.badges,
        ...
        assert((badges != null && badges.isNotEmpty) ? badges.length == labels.length : true), super(key: key);
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    SvgPicture.asset(
                                      ...
                                      height: 20,//widget.tabIconSelectedSize,
                                      width: 20,//widget.tabIconSelectedSize,
                                      fit: BoxFit.cover,
                                    ),
                                    // Icon(
                                    //   activeIcon,
